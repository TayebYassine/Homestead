...
|---------------------------|:-------------:|:-------------:|--------------------------------------------|
| `break-blocks`            |      `1`      |     Deny      | Break/destroy blocks                       |
| `place-blocks`            |      `2`      |     Deny      | Place blocks                               |
| `containers`              |      `4`      |     Deny      | Open chests, barrels, shulker boxes        |
| `doors`                   |      `8`      |     Deny      | Open/close doors                           |
| `trap-doors`              |     `16`      |     Deny      | Open/close trapdoors                       |
| `fence-gates`             |     `32`      |     Deny      | Open/close fence gates                     |
...
| `frost-walker`            |    `8192`     |     Deny      | Use frost walker boots                     |
| `harvest-crops`           |    `16384`    |     Deny      | Harvest/break crops                        |
| `block-trampling`         |    `32768`    |     Deny      | Trample farmland/turtle eggs               |
| `general-interaction`     |    `65536`    |     Deny      | General interaction catch-all              |
...
| `passthrough`             |  `67108864`   |     Allow     | Enter/move through region (Deny = private) |
| `pvp`                     |  `134217728`  |     Deny      | PvP combat                                 |
| `take-fall-damage`        |  `268435456`  |     Allow     | Fall damage (Deny for parkour)             |
| `teleport`                |  `536870912`  |     Deny      | Ender pearls/chorus fruit                  |
| `throw-potions`           | `1073741824`  |     Deny      | Splash/lingering potions                   |
