...
/**
 * World flag configuration menu for a region.
 *
 * <p>Allows toggling world flags (e.g., explosions, fire spread, mob spawning) that affect the
 * region's world behavior.</p>
 */
public final class RegionWorldFlagsMenu {
    private static final String MENU_KEY = "region_world_flags";
    ...
    private void handleFlagClick(Player player, Region region, PaginationMenu.ClickContext context) {
        ...
        String flagString = WorldFlag.getFlags().get(context.index());
