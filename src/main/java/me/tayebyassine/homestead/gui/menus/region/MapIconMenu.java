...
/**
 * Paginated map icon picker for regions with dynamic map support.
 *
 * <p>Displays available icon options. Selected icon is highlighted with an enchant glint.</p>
 */
public final class MapIconMenu {
    private static final String MENU_KEY = "map_icon";
    ...
    public MapIconMenu(Player player, Region region) {
        ...
        PaginationMenu.builder(MENU_KEY, new Placeholder().add("{region}", region.getName()), 9 * 4)
