...
/**
 * Per-member player flag configuration menu for a sub-area.
 *
 * <p>Allows toggling individual player flags for a specific sub-area member. Includes a bulk
 * enable/disable option at index 0.</p>
 */
public final class SubAreaMemberFlags {
    private static final String MENU_KEY = "sub_area_member_flags";
