...
public final class RegionManager {
    ...
    public static Region createRegion(String name, OfflinePlayer player) {
        ...
        region.setDescription(Resources.<LanguageFile>get(ResourceType.Language).getDefaultRegionDescription());
        ...
        if (Resources.<RegionsFile>get(ResourceType.Regions).isUpkeepEnabled()) {
            int delay = Resources.<RegionsFile>get(ResourceType.Regions).getStartUpkeep();
