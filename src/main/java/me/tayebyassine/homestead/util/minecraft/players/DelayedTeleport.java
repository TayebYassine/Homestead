...
public final class DelayedTeleport {
    ...
    public DelayedTeleport(Player player, Location location) {
        ...
        boolean delayedTeleportEnabled = Resources.<RegionsFile>get(ResourceType.Regions).isDelayedTeleportEnabled();
        ...
        boolean ignoreOperators = Resources.<RegionsFile>get(ResourceType.Regions).isDelayedTeleportIgnoreOperators();
        ...
        int delay = Resources.<RegionsFile>get(ResourceType.Regions).getDelayedTeleportDelay();

        initialLocations.put(playerId, player.getLocation().clone());

        boolean bossBarEnabled = Resources.<RegionsFile>get(ResourceType.Regions).isDelayedTeleportBossBarEnabled();
        ...
        TaskHandle task = Homestead.getInstance().runPlayerTaskLater(player, () -> {
            ...
            double price = Resources.<RegionsFile>get(ResourceType.Regions).getDelayedTeleportPrice();
