...
import me.tayebyassine.homestead.integrations.bstats.Metrics;
...
public final class bStats {
    public bStats(Homestead plugin) {
        try {
            ...
            // Discord Webhook
            metrics.addCustomChart(new Metrics.SimplePie("discord_webhook", () -> Resources.<ConfigFile>get(ResourceType.Config).isDiscordEnabled() ? "Enabled" : "Disabled"));
