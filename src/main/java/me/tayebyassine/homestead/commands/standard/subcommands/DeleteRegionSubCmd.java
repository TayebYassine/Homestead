...
/**
 * Sub-command ({@code /hs delete}) that deletes the current region after confirmation.
 */
public final class DeleteRegionSubCmd extends SubCommandBuilder {

    public DeleteRegionSubCmd() {
        super("delete");
        setRegionPermission("homestead.actions.regions.delete");
