...
public class TopMembersRegionMenu {
	List<Region> regions;

	public TopMembersRegionMenu(Player player) {
		regions = new ArrayList<>();
		regions.addAll(RegionsManager.sortRegions(RegionsManager.RegionSorting.MEMBERS_COUNT));

		regions = ListUtils.removeDuplications(regions);

		PaginationMenu gui = new PaginationMenu(MenuUtils.getTitle(20), 9 * 5,
		...
		gui.addActionButton(1, MenuUtils.getButton(58), (_player, event) -> {
